...
def main():
    ...
    generate_image_grid('D:\Projects\EDM-AOTimproved\\Non-Conditioned.pkl', 'cifar10-32x32.png', num_steps=18) # FID = 1.79, NFE = 35
    generate_image_grid('D:\Projects\EDM-AOTimproved\\Conditioned.pkl', 'cifar10-32x32_cond.png', num_steps=18) # FID = 2.39, NFE = 79
#----------------------------------------------------------------------------
