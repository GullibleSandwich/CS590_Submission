...
def training_loop(
    ...
    dataset_iterator = iter(torch.utils.data.DataLoader(dataset=dataset_obj, sampler=dataset_sampler, batch_size=large, **data_loader_kwargs))
    ...
    loss_fn = dnnlib.util.construct_class_by_name(**loss_kwargs, batch = batch_gpu) # training.loss.(VP|VE|EDM)Loss
